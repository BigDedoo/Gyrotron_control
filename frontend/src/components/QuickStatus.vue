    ...
    <CardContent class="space-y-4">
      ...
      <div>
        ...
        <div v-if="faults.length === 0">
          <span class="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-emerald-600 text-primary-foreground hover:bg-emerald-600/80">None</span>
        </div>
