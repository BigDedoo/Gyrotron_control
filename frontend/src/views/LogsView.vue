...
<template>
  <Card class="rounded-2xl">
    <CardHeader class="pb-2"><CardTitle class="text-base">Event Log (mock)</CardTitle></CardHeader>
    <CardContent>
      <div class="grid grid-cols-12 text-xs uppercase text-muted-foreground mb-2">
