  ...
  <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
    <Card class="rounded-2xl xl:col-span-2">
      <CardHeader class="pb-2 flex flex-row items-center justify-between">
        <CardTitle class="flex items-center gap-2 text-base"><Activity class="size-4" /> System Overview</CardTitle>
        <Badge :variant="ok ? 'default' : 'destructive'" class="text-xs px-3 py-1 rounded-full">{{ ok ? "All systems nominal" : `${faults.length} alarm(s)` }}</Badge>
      </CardHeader>
      <CardContent>
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card class="rounded-2xl">
            <CardHeader class="pb-2"><CardTitle class="text-sm">Heater Voltage (live)</CardTitle></CardHeader>
            <CardContent>
              <div class="h-40">
          ...
          <Card class="rounded-2xl">
            <CardHeader class="pb-2"><CardTitle class="text-sm">Ion Pump Current (live)</CardTitle></CardHeader>
            <CardContent>
              <div class="h-40">
